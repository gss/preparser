  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ToEndIdInjector": parse_ToEndIdInjector,
      ...
      function parse_ToEndIdInjector() {
        var result0, result1, result2;
        ...
        if (result0 !== null) {
          result0 = (function(offset, x) {return " " + p.stringify(x) + " name(" + p.cid() + ");";})(pos0, result0[0]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, x) {p.cid(); return " " + p.stringify(x) + ";";})(pos0, result0[0]);
          }
          if (result0 === null) {
            pos = pos0;
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, x) {return     p.error("Invalid Name, must have value",line,column);})(pos0, result0[0]);
            }
            if (result0 === null) {
              pos = pos0;
            }
      ...
      function computeErrorPosition() {
        ...
        if (p.blockCount == null) { // shared state for lifetime of parser
          p.blockCount = 0;
        }   
        p.bid = function () {
          p.blockCount++;
        ...
        if (p.constraintCount == null) { // shared state for lifetime of parser
          p.constraintCount = 0;
        }   
        p.cid = function () {
          p.constraintCount++;
          return "c"+p.constraintCount;
        }    
